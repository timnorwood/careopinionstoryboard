...
<!-- This code chunk creates the prem markdown pages using premFrame supplied -->
```{r prem-pages, child='20260714_storyboard_prem.Rmd'}
```

<!-- This code chunk creates the specialty markdown pages for the specialty groups listed -->
<!-- in page_groups, using storyFrame, tagFrame and allFrame supplied -->
```{r run-out, echo=FALSE, results='asis'}
options(knitr.duplicate.label = 'allow')

out = NULL
for (page_group in page_groups) {
out = c(out, knit_child('20230608_storyboard_pages.Rmd', quiet = TRUE))
}
cat(out, sep = '\n')
```
