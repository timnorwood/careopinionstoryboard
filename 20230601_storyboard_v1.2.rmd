...
#opts_knit$set(root.dir="N:\\Evidence\\DMBI\\Care Opinion") #changes root directory in next chunk
label = params$label
...
n = allFrame %>% 
 ...
 #                    "moderately critical", "strongly critical", "severely critical")))) %>%
  ...
  mutate(#NACS = ifelse(NACorg != POname, " Hospitals and facilities elsewhere", NACS),
         NACS = ifelse(NACS == "", shpName, NACS), # Replace blank NACS with NHS board name
